...
p_coef1 <- ggplot(data = plot_coef1, aes(x = time)) +
    ...
    scale_color_manual(values = my_colors,
                       breaks = c("loglogistic lfAFT", "lognormal lfAFT")) +
...
leg <- cowplot::get_legend(p_coef1 + theme(legend.position = "top"))
...
for(k in 1:n_folds){
    ...
    fit_logistic = pfr(is_user_60 ~ age_in_years + bmi + lf(X_mat, argvals = sgrid), 
