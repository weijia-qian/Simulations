...
table_time <- all_info %>%
  filter(nS == 100 & family == "lognormal") %>%
...
plot_Brier %>%
  ...
  labs(x = "density of grid", y = "out-of-sample Brier score", fill = "model"
       )
...
plot_mise_coef <- table_mise_coef %>%
  ...
  scale_fill_manual(values = my_colors) +
  facet_grid(family~n, labeller = label_both, scales = "free") +
  labs(x = "density of grid", y = expression("log MISE of"~beta(s)), fill = "model"
       ) +
  theme(
...
plot_mise_surv <- table_mise_surv %>%
  ...
  scale_fill_manual(values = my_colors) +
  facet_grid(family~n, labeller = label_both, scales = "free") +
  labs(x = "density of grid", y = "log MISE of survival function", fill = "model"
       )
  theme(axis.title=element_text(size=10))
