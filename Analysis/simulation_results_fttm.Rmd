...
table_Brier <- all_info %>%
  pivot_longer(cols = c("Brier_norm", "Brier_cox", "Brier_faft2", "Brier_fttm"),
               names_to = "type",
               values_to = "value") %>%
  mutate(est_model = case_when(
            str_detect(type, "cox") ~ "LFCM",
...
table_mise_coef <- all_coef %>%
  pivot_longer(cols = c("mise_coef_norm", "mise_coef_cox", "mise_coef_faft2", "mise_coef_fttm"),
               names_to = "type",
               values_to = "value") %>%
...
table_mise_surv <- all_surv %>%
  pivot_longer(cols = c("mise_surv_norm", "mise_surv_cox", "mise_surv_faft2", "mise_surv_fttm"),
               names_to = "type",
               values_to = "value") %>%
  mutate(est_model = case_when(str_detect(type, "cox") ~ "LFCM",
                               str_detect(type, "fttm") ~ "FTTM",
